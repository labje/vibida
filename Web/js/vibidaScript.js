...
function initDip(){
  ...
  //Se carga la diputación de Zaragoza por defecto
...
function initMun(){
  ...
  $("select#provincias option[value='50']").prop("selected", true);
  loadMun("50"); //Se carga la lista de municipios de Zaragoza por defecto
